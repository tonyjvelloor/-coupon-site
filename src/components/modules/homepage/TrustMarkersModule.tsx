...
export function TrustMarkersModule() {
    return (
        <section className="border-b border-gray-200 dark:border-gray-800 bg-gray-50 dark:bg-gray-900 py-6 relative z-20 transition-colors duration-300">
            <div className="max-w-container-max mx-auto px-margin-mobile md:px-margin-desktop flex flex-col md:flex-row items-center justify-between gap-6">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <p className="font-title-md font-bold text-gray-900 dark:text-white leading-tight">100% Human Verified</p>
                        <p className="font-label-md text-label-sm text-gray-600 dark:text-gray-400">Every coupon tested today</p>
                    </div>
                </div>
                
                <div className="hidden lg:flex flex-1 items-center justify-center border-x border-gray-200 dark:border-gray-800 px-8">
                ...
                <div className="flex items-center gap-4">
                    <div className="flex flex-col items-end">
                        ...
                        <p className="font-label-md text-label-sm text-gray-600 dark:text-gray-400">4.8/5 on Trustpilot</p>
                    </div>
                </div>
            </div>
        </section>
