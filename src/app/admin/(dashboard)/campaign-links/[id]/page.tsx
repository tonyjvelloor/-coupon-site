...
import { Link2, ArrowLeft, Save, ExternalLink, Sparkles, Trash2 } from "lucide-react";
...
export default function EditCampaignLinkPage(props: { params: Promise<{ id: string }> }) {
    ...
    useEffect(() => {
        ...
        // Fetch current campaign link
        fetch(`/api/admin/campaign-links/${params.id}`)
            .then(async (res) => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            const res = await fetch(`/api/admin/campaign-links/${params.id}`, {
                method: "PUT",
            ...
            <div className="flex items-center gap-4 mb-8">
                ...
                <div>
                    ...
                    <p className="text-gray-600 mt-1">
                        Update masked URL settings and destination
                    </p>
                </div>
            </div>
